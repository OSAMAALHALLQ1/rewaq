...
description: Use this skill for Rawaq workflow automation: recipe stock deduction, low-stock alerts, purchase approvals, daily closing, kitchen routing, and long-running restaurant processes.
model: inherit
---
