...
description: Use this skill for Rawaq payments, cashier settlement, refunds, delivery app payments, subscriptions, billing, reconciliation, and secure payment flows.
model: sonnet
---
