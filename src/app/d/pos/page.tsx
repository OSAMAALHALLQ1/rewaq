        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              {!isOnline && <Badge tone="danger" className="text-[10px] h-5">غير متصل</Badge>}
              {syncQueue.length > 0 && <Badge tone="warning" className="text-[10px] h-5">{syncQueue.length} معلقة</Badge>}
            </div>
