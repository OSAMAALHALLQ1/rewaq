...
export type Database = {
  public: {
    Tables: {
      ...
      team_invites: {
        Row: {
          ...
          employee_code_ciphertext: string | null;
        };
        Insert: {
          id?: string;
          organization_id: string;
      ...
      catalog_item_kitchen_routes: { Row: { id: string; organization_id: string; branch_id: string; catalog_item_id: string; station_id: string; is_active: boolean; created_by_user_id: string | null; created_at: string; updated_at: string; }; Insert: { id?: string; organization_id: string; branch_id: string; catalog_item_id: string; station_id: string; is_active?: boolean; created_by_user_id?: string | null; created_at?: string; updated_at?: string; }; Update: { id?: string; organization_id?: string; branch_id?: string; catalog_item_id?: string; station_id?: string; is_active?: boolean; created_by_user_id?: string | null; created_at?: string; updated_at?: string; }; Relationships: []; };
    ...
    Functions: {
      ...
      provision_restaurant_workflow_device_v2_atomic: { Args: { p_organization_id: string; p_branch_id: string; p_station_id: string | null; p_device_name: string; p_key_hash: string; p_role: Database["public"]["Enums"]["app_role"]; p_allowed_modules: string[]; p_actor_user_id: string; }; Returns: Json; };
      upsert_catalog_item_kitchen_route_atomic: { Args: { p_organization_id: string; p_branch_id: string; p_catalog_item_id: string; p_station_id: string; p_is_active: boolean; p_actor_user_id: string; }; Returns: Json; };
      provision_department_device_atomic: { Args: { p_organization_id: string; p_branch_id: string | null; p_device_name: string; p_key_hash: string; p_role: Database["public"]["Enums"]["app_role"]; p_allowed_modules: string[]; p_actor_user_id: string; }; Returns: Json; };
      upsert_branch_atomic: { Args: { p_organization_id: string; p_branch_id: string | null; p_name: string; p_actor_user_id: string; }; Returns: Json; };
