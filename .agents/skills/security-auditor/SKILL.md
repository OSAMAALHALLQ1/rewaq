...
description: Use this skill for Rawaq security: owner, manager, cashier, kitchen, warehouse, accountant permissions, Supabase RLS, approval gates, invoice integrity, and inventory fraud prevention.
model: opus
---
