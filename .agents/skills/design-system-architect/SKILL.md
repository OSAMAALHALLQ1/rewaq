...
description: Use this skill for the Rawaq design system: Arabic dashboards, POS controls, tables, cards, status states, responsive layouts, and consistent restaurant operations UI.
model: inherit
color: magenta
---
