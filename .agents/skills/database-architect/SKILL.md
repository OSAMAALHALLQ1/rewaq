...
description: Use this skill for Rawaq Supabase schema design: products, recipes, ingredients, warehouses, stock movements, invoices, suppliers, returns, waste, roles, audit logs, and accounting ledger.
model: opus
---
